...
\begin{definition}
  \lean{CategoryTheory.FactorizationSystem}
  \leanok
...
\begin{definition}
  \lean{CategoryTheory.MorphismPropertySlice}
  \leanok
...
\begin{lemma}
  \lean{CategoryTheory.FactorizationSystemSlice}
  \leanok
...
\begin{lemma}
  \lean{CategoryTheory.left_right_intersection_iso}
  \leanok
...
\begin{lemma}
  \lean{CategoryTheory.right_cancellation_left_class}
  \lean{CategoryTheory.left_cancellation_right_class}
  \leanok
...
\begin{definition}
  \lean{CategoryTheory.orthogonal}
  \lean{CategoryTheory.orthogonal_class}
  \leanok
...
\begin{lemma}
  \lean{CategoryTheory.hom_orthogonal_implies_orthogonal}
  \lean{CategoryTheory.orthogonal_implies_hom_orthogonal}
  \leanok
...
\begin{definition}
  \lean{CategoryTheory.left_orthogonal_complement}
  \lean{CategoryTheory.right_orthogonal_complement}
  \leanok
...
\begin{lemma}
  \lean{CategoryTheory.Arrow.is_closed_under_limits_r_ort_complement}
  \lean{CategoryTheory.Arrow.is_closed_under_comp_r_ort_complement}
  \lean{CategoryTheory.Arrow.left_cancellation_r_ort_complement}
  \lean{CategoryTheory.Arrow.base_change_r_ort_complement}
  \lean{CategoryTheory.Arrow.contains_isos_right_ort_complement}
  \leanok
...
\begin{theorem}
  \lean{CategoryTheory.FactorizationSystem_characterization}
  \leanok
